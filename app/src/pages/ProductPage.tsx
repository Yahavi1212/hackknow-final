              ...
              <div className="flex items-baseline gap-3 mb-6">
                {product.isFree ? (
                  ...
                  <>
                    ...
                    {product.originalPrice && (
                      <Badge className="bg-hack-yellow/20 text-hack-black font-bold">
            ...
            <TabsContent value="description" className="mt-6">
              <div className="bg-white rounded-2xl p-6 lg:p-8 border border-hack-black/5">
                ...
                <p className="text-hack-black/70 leading-relaxed">
                  {product.description} This premium digital asset is designed
                  to save you time and elevate your projects. All files are
                  professionally crafted, fully editable, and ready to use
                  immediately after download. Compatible with all major
                  software platforms.
                </p>
                  ...
                  {[
                    {
                      ...
                      rating: 5,
                      date: "2 weeks ago",
                      text: "Absolutely love this template! Saved me so much time and the quality is top-notch.",
                    },
                    {
                      name: "Maria Garcia",
                      rating: 5,
                      date: "1 month ago",
                      text: "Best purchase I've made this year. Highly professional and easy to customize.",
                    },
                    {
                      name: "James Wilson",
                      rating: 4,
                      date: "2 months ago",
                      text: "Great quality product. Minor tweaks needed but overall very satisfied.",
                    },
                  ].map((review, index) => (
                    <div
                      key={index}
                      className="border-t border-hack-black/5 pt-4"
                    >
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <div className="ml-auto flex gap-0.5">
                          {Array.from({ length: review.rating }).map((_, i) => (
                            <Star
                              key={i}
                              className="w-3 h-3 fill-hack-yellow text-hack-yellow"
                            />
                          ))}
                        </div>
                      </div>
